...
function applyFooters(doc) {
	...
	for (let i = 1; i <= totalPages; i++) {
		...
		doc.text('Generated by Agri-Sphere', 15, pageHeight - 10);
		doc.text(`© ${now.getFullYear()} Agri-Sphere. All rights reserved.`, 15, pageHeight - 6);
...
function getReportTitle(type) {
	...
	return titles[type] || 'Agri-Sphere Dynamic Report';
}
